  ...
  template: `
    ...
    <div class="ui-g-12 ui-md-4">
      ...
      <div *ngIf="error !== undefined">
        <p *ngIf="error; else success" class="text-danger">Unable to read image. Please check your link.</p>
        <ng-template #success><p class="text-success">Image successfully selected</p></ng-template>
      </div>
    </div>
  `
})
